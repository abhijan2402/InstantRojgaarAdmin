    ...
    return (
        <div className='landingPage_main_container'>
            ...
            <div className="landingPage_btn">
                ...
                <button className='companies_btn' onClick={handleShowCompanies}>Show New Companies</button>
                <button className='jobs_btn' onClick={handleShowJobs}>Show New Jobs</button>
            </div>
